...
void Withdraw(double amount){
  double total+amount=transcationFee;
if(total<=balance){
balance=total;
cout<<"Withdrawn:₹"<<amount<<"(₹"<<transcationFee<<"fee applied)"<<
  endl;
} else {
...
cout<<"Account Number:"<<accountNumber<<endl;
cout<<"Balance:₹"<<balance<<endl;
cout<<"Transcation Fee:₹"<<transactionFee<<endl;
}
};
int main(){
